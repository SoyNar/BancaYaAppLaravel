...
@section('content')
    ...
    <div class="flex gap-4">
        <div
            class="w-1/2 h-[75vh] overflow-hidden bg-[#1e3a8a] text-white rounded-10xl p-4 rounded-[45px] flex gap-10 flex-col items-center justify-center">
            <h1 class="text-[5vh] font-bold font-mochiy-pop-one">Pide tu prestamo ya</h1>
            <img class="h-[60vh]" src="{{ asset('img/loan-purple.png') }}" alt="Logo">
        </div>

        <div class="w-1/2 bg-blue-300 p-4">
            <table class="min-w-full bg-white border-5 border-black-300" style="text-align: center;">
                <tr class="bg-gray-100">
                    <th class="px-4 py-2 border border-black-300 text-[5vh]">Modulos</th>
                    <th class="px-4 py-2 border border-black-300 text-[5vh]">Turno</th>
                </tr>
                <tr class="bg-gray-50">
                    <td class="px-4 py-2 border border-black-300">
                        <span class="text-[5vh] font-black">1</span>
                    </td>
                    <td class="px-4 py-2 border border-black-300 flex items-center justify-center">
                        <div class="w-[24vh] h-[10.5vh]  text-white font-bold text-[5vh] rounded-3xl flex items-center justify-center"
                ...
                <tr class="bg-gray-50">
                    <td class="px-4 py-2 border border-black-300">
                        <span class="text-[5vh] font-black">2</span>
                    </td>
                    <td class="px-4 py-2 border border-black-300 flex items-center justify-center">
                        <div class="w-[24vh] h-[10.5vh] text-white font-bold text-[5vh] rounded-3xl flex items-center justify-center"
                ...
                <tr class="bg-gray-50">
                    <td class="border border-black-300">
                        <span class="text-[5vh] font-black">3</span>
                    </td>
                ...
                <tr class="bg-gray-50">
                    <td class="border border-black-300">
                        <span class="text-[5vh] font-black">4</span>
                    </td>
                    <td class="px-2 py-2 border border-black-300 flex items-center justify-center">
                        <div class="w-[24vh] h-[10.5vh] text-white font-bold text-[5vh] rounded-3xl flex items-center justify-center"
                ...
                <tr class="bg-gray-50">
                    <td class="border border-black-300">
                        <span class="text-[5vh] font-black">5</span>
                    </td>
                    <td class="px-2 py-2 border border-black-300 flex items-center justify-center">
                        <div class="w-[24vh] h-[10.5vh] text-white font-bold text-[5vh] rounded-3xl flex items-center justify-center"
                            style="background-color: #cebd20">
