            ...
            <div class="flex justify-center items-center min-h-screen">
                <div class="w-full max-w-3xl px-4 mx-auto flex flex-col items-center space-y-6">
                    ...
                    <div class="w-full max-w-3xl grid grid-cols-2 gap-4">
                        ...
                        <label for="opcion1" class="w-full text-center py-3 px-6 bg-blue-800  text-white font-bold rounded-lg cursor-pointer peer-checked/opcion1:bg-blue-500 peer-checked/opcion1:text-white">
                            Apertura de Cuenta
                        </label>

                        <input type="radio" id="opcion2" name="categoria" value="opcion2" class="hidden peer/opcion2">
                        <label for="opcion2" class="w-full text-center py-3 px-6 bg-teal-600  text-white font-bold rounded-lg cursor-pointer peer-checked/opcion2:bg-blue-500 peer-checked/opcion2:text-white">
                            Retiros y depósitos
                        </label>

                        <input type="radio" id="opcion3" name="categoria" value="opcion3" class="hidden peer/opcion3">
                        <label for="opcion3" class="w-full text-center py-3 px-6 bg-teal-600 text-white font-bold rounded-lg cursor-pointer peer-checked/opcion3:bg-blue-500 peer-checked/opcion3:text-white">
                            Consulta y asesoria
                        </label>

                        <input type="radio" id="opcion4" name="categoria" value="opcion4" class="hidden peer/opcion4">
                        <label for="opcion4" class="w-full text-center py-3 px-6 bg-blue-800   text-white font-bold rounded-lg cursor-pointer peer-checked/opcion4:bg-blue-500 peer-checked/opcion4:text-white">
